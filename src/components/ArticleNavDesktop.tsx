...
export default function ArticleNavDesktop({ groups, language }: ArticleNavDesktopProps) {
  ...
  return (
    <div className="related-scroll bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-lg border border-slate-200 dark:border-slate-700 shadow-lg p-4 max-h-[60vh] overflow-y-auto overscroll-contain">
